...
Current version
  - Added "Spread Text" option under Country Label section in inspector
  - Added "Zoom On Cursor" option to inspector under Interaction settings

Version 7.6.1 11/Nov/2021
  - [Fix] Map Editor: fixed issue when transferring the last region of a country

Version 7.6 10/Sep/2021
  - Added support for multiple displays
  - [Fix] Fixed geodata files

Version 7.5 7/Apr/2021
  - API: added SetCountryRegionMaterial, SetProvinceRegionMaterial
  - [Fix] Fixed a redraw issue which left previous frontiers drawn

Version 7.4
  - Setting fitWindowWidth to true no longer calls CenterMap() avoiding moving the camera. Call CenterMap() manually if needed.

Version 7.3
  - Improved memory handling for temporary objects
  - Improved data loading times

Version 7.2
  - Added "Respect Other UI" option
  - Upgraded to Unity 2018.4

Version 7.1.1
  - [Fix] Fixed country names not showing in Earth 16K styles

Version 7.1
  - Map Editor: general improvements and fixes
  - Map Editor: Added map editor context menu to fix cities without provinces

Version 7.0.2
  - Improvements to sprite marker handling
  - [Fix] Fixed province color returning issue when hiding the highlight effect

Version 7.0.1
  - [Fix] Fixed flickering issue with city icons

Version 7.0
  - Added support for LWRP 5.16
...
Version 6.1.1
  ...
  - [Fix] Fixed graphic glitch with 16K Earth styles and MSAA
