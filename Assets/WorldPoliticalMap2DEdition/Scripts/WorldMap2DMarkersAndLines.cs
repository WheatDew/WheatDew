...
namespace WPMF
{
	...
	#region Public API area
		...
		public void AddMarker (GameObject marker, Vector3 planeLocation, float markerScale)
		{
			...
			float h = height * markerScale / planeLocation.magnitude; // lift the marker so it appears on the surface of the map
			...
			Vector3 scale = new Vector3(markerScale, prop * markerScale, markerScale);
