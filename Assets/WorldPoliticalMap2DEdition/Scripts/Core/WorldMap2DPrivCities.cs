...
namespace WPMF {
	...
	public partial class WorldMap2D : MonoBehaviour {
		...
		void ReadCitiesPackedString () {
			const string cityCatalogFileName = "WPMF/Geodata/cities10";
	...
	#region Drawing stuff
		...
		public void DrawCities () {
			...
			citiesLayer.hideFlags = HideFlags.DontSaveInEditor;
			...
			for (int k=0; k<cities.Count; k++) {
				...
				if (city.isVisible) {
					...
					cityObj.hideFlags = HideFlags.DontSaveInEditor | HideFlags.HideInHierarchy;
