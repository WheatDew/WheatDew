		...
		public Font font {
			...
			set {
				if (_font != value) {
					_font = value;
					if (_font != null) {
						Material fontMaterial = UnityEngine.Object.Instantiate(Resources.Load<Material>("WPMF/Materials/Font")); // this material is linked to a shader that has into account zbuffer
