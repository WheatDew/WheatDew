...
namespace Origin
{
    public class PackSystem : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //初始化测试数据
            itemEffectList.Add("草", new ItemEffectData(2));
            itemEffectList.Add("土豆", new ItemEffectData(10));
            itemEffectList.Add("烤土豆", new ItemEffectData(30));
            itemEffectList.Add("柠檬", new ItemEffectData(5));
            itemEffectList.Add("烤柠檬", new ItemEffectData(10));
        }
